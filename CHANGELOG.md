...
### Fixed
- Updated README macOS installation instructions to match actual release artifacts (tar.gz, not DMG)

## [1.0.10] - 2026-01-30

### Fixed
- Updated README Linux installation instructions to match actual release artifacts

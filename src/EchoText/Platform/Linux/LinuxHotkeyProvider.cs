...
/// <summary>
/// Linux implementation of global hotkey registration using SharpHook
/// Works on X11. For Wayland, may have limitations depending on compositor.
/// </summary>
public class LinuxHotkeyProvider : IPlatformHotkey
{
    ...
    {
        if (_disposed)
            throw new ObjectDisposedException(nameof(LinuxHotkeyProvider));
    ...
    private KeyModifiers GetCurrentModifiers(KeyboardHookEventArgs e)
    {
        ...
        // Check for Meta (Super/Windows key)
